    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
          //  Class.forName("com.mysql.jdbc.Driver");
            ...
            Connection con = DriverManager.getConnection(databaseURL, "root", "ali");
            Statement stat = con.createStatement();    
            String selectQuery = "select * from bus_details1 where busdeparture='"+source+"' and busdestination='"+destination+"' and departDate between '"+fromDateFormated+"' and '"+toDateFormated+"'";
            ResultSet rs=stat.executeQuery(selectQuery);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try {
        //    Class.forName("com.mysql.jdbc.Driver");
            ...
            Connection con = DriverManager.getConnection(databaseURL, "root", "ali");
            Statement stat = con.createStatement();    
            String insertQuery = "insert into user_booking1 values('"+luser +"','" +source+ "','" +destination+ "','" + fromDate+ "','" + toDate + "')";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       int a;
        ...
        try {
            ...
            Connection con = DriverManager.getConnection(databaseURL, "root", "ali");
            Statement stat = con.createStatement();
            String query="SELECT * FROM bus_details1 where busdeparture="+source+" and busdestination="+destination;
            ResultSet result;
            result=stat.executeQuery(query);
            result.next();
            a=result.getInt("seat");
            System.out.println(a);
            at.setText(""+a);
            String insertQuery = "Update bus_details1 SET total_seat="+(a-1)+"Where total_seat="+a;
            stat.executeUpdate(insertQuery);
