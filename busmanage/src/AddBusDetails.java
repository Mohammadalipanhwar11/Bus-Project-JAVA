...
public class AddBusDetails extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        moveCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sindh", "Punjab", "Balochistan", "KPK", "GB" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          try
        {
            ...
            String selectQuery = "select * from bus_details1 where busno='"+busnoD+"'";
           ...
           {
         String insertQuery = "insert into bus_details1 values('" + busnoD + "','" + busMoveD + "','" + bussourceD + "','" + busdestD + "','" + departDate + "','" + departTimeD + "','" + priceD + "','" + seatD + "','"+ stopA+"','"+ stopB+"','"+ stopC+"')";
